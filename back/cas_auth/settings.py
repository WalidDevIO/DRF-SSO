"""
Django settings for cas_auth project.
...
SECRET_KEY = 'django-insecure-frkte%(zxcr!1cxr9^*7qqxgv1$9p2ehh(bg$%xj@#%2l)0+gu'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "134.246.147.156"]
...
WSGI_APPLICATION = 'cas_auth.wsgi.application'
